...
const introRoutes=require("./introduce.route")
...
module.exports=(app)=>{
    ...
    app.use("/introduce",categoryMiddleware.category,cartMiddleware.cardId,  userMiddleware.infoUser,settingMiddleware.settingGeneral, introRoutes);
}
